...
if(isset($_GET['remove_pr'])){
 ...
 $sql="select * from `".TB_pre."users` ORDER BY id DESC ";
...
$rfcSum = $rfcRow['SUM(raffle_coupons)'];
                        if($rfcSum > 0) {echo $rfcSum; }else {echo '0'; } ; ?>
                    
                    </td>
                        <td><?php echo $res['profile_created']; ?></td>
						            <!-- <td><?php // echo $res['invoice_no']; ?></td> -->
            
                       
                        <td><a href="user-profile.php?u_id=<?php echo $res['id']; ?>" class="btn btn-primary" title="">View</a>&nbsp;
